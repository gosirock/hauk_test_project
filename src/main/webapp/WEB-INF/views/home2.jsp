...
<body>
	...
	<div class="bg">
		...
		<div class="bg_sub_text">
			<span>가비아 글꼴 프로젝트는 가비아와 대학교가 무료 글꼴을 만드는
				<br>프로젝트입니다. 더 많은
				분들이 온라인 공간에서 한글의 아름다움을 
				<br>접할 수 있도록 가비아 글꼴을 나눕니다.
			</span>
		</div>
		<div class="bg_icon">
	...
	<div class="content_area">
		...
		<div class="portfolio_sub_text">
			<span>미술에 재능이 있어도 사회에 첫 발을 내딛기 어려운 발달장애인<br>청년들을 지지하며 지역사회와 소통할 수 있게 이어주는 파란조약돌.
			</span>
		</div>
		...
		<div class="portfolio_viewarea">
			<div class="portfolio_view">
				<img src="./resources/images/____2.png">
				<span>한국남부발전</span>
				<span>중잔기 경영전략 및 조직개편 사내보고 PT</span>
			</div>
			<div class="portfolio_view">
				<img src="./resources/images/_______3.png">
				<span>한국남부발전</span>
				<span>중잔기 경영전략 및 조직개편 사내보고 PT</span>
			</div>
			<div class="portfolio_view">
		...
		<div class="inquire">
			<span class="inquire_main_text">늘 새로운 크리에이티브로 변화를 이끌어 갑니다.</span>
			<span class="inquire_sub_text"><br>컨설팅을 의뢰해주시면 확인 후 최대한 빠르게 답변드릴 예정입니다. 전문가의 분석 및 상담 후 진행되며, 브랜드에 적절한 전략을 제안드립니다.</span>
		</div>
	</div>
	<footer> 
